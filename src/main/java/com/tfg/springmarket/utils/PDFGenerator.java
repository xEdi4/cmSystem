...
public class PDFGenerator {
    ...
    public static ByteArrayOutputStream generarReporteEstablecimiento(Usuario usuario, List<VentasEstablecimiento> ventas, List<VentasProveedor> compras, LocalDate fechaInicio, LocalDate fechaFin) {
        ...
        Paragraph infoCabecera = new Paragraph()
                .add("Establecimiento: " + usuario.getNombre() + "\n")
                .add("Teléfono: " + usuario.getTelefono() + "\n")
                .add("Email: " +  usuario.getCorreo() )
                .setFontSize(10)
                .setMarginBottom(10);
    ...
    public static ByteArrayOutputStream generarReporteProveedor(Usuario usuario, List<VentasProveedor> ventas, LocalDate fechaInicio, LocalDate fechaFin) {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        PdfWriter writer = new PdfWriter(baos);
        PdfDocument pdf = new PdfDocument(writer);
        Document document = new Document(pdf);
